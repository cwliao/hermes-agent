...
| `CI-BASELINE-001` | `IMPLEMENTED_PENDING_REVIEW` | Five failures fixed; affected modules, ARCH-001 regression, Ruff, compileall, and GitHub Actions run `31379116076` pass; code review remains. |
