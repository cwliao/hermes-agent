...
def _cmd_dispatch(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        # Share the gateway's resolver rather than coercing here (OOF-30/
        # OOF-77, WORKER-TIMEOUT-CONTENTION-001): this path is what cron
        # invokes, and the docstring above promises the two behave alike --
        # resolving the same key two ways is how that promise quietly stops
        # being true.
