...
_SPECS = [
    ...
    _cmd("swarm", [
        ...
        _arg("--worker-lane", action="append", default=[],
             choices=["native_hermes", "claude", "grok", "agy"],
             help="Expected worker lane, in the same order as --worker (repeatable)"),
        _arg("--goal-max-turns", type=int, default=5,
             help="Goal-loop turn budget for a lane-bound swarm"),
        _arg("--worker-max-runtime", type=int, default=120,
